...
class Map extends Component {
	...
	componentDidMount() {
		...
		this.map = L.map(`map-${this.props.id}`, Object.assign({}, this.props.mapOptions, {
			crs: L.CRS.Simple,
			center: [-2128,2048],
			zoom: -3,
		...
		window.map = this.map;
		L.tileLayer(this.props.tileLayerTemplate, Object.assign({}, this.props.tileLayerOptions, {
			minZoom: -3,
			maxZoom: 2,
			nativeZooms: [0],
